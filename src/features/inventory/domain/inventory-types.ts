...
export interface ProductEntity { id: string; businessId: string; type: ProductType; sku: string; barcode?: string | null; name: string; description?: string | null; categoryId?: string | null; inventoryAccountId?: string | null; cogsAccountId?: string | null; revenueAccountId: string; trackStock: boolean; isActive: boolean; sellPrice?: bigint | null; }
...
export interface UpdateProductInput { businessId: string; productId: string; type: ProductType; sku: string; barcode?: string | null; name: string; description?: string | null; categoryId?: string | null; inventoryAccountId?: string | null; cogsAccountId?: string | null; revenueAccountId: string; trackStock?: boolean; buyPrice?: bigint; sellPrice?: bigint; }
